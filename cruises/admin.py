...
from .models import Destination, Ships, SuiteCategories, Suites, Tag, Cruises, Fares, Movements, Tickets, Bookings  # noqa
...
class DestinationAdmin(admin.ModelAdmin):
    ...
    ordering = ('name',)
    fields = ('name', 'country', 'continent', 'description',
              'image', 'latitude', 'longitude', 'slug',)
...
class CategoriesAdmin(admin.ModelAdmin):
    ...
    fields = ('name', 'description', 'sleeps', 'size', 'suite_image',
              'suite_layout_image', 'suite_feature_list', 'category_deckplan')
...
class CruisesAdmin(admin.ModelAdmin):
    list_display = ('name', 'ship', 'start_date', 'end_date',
                    'bookable', 'slug', 'port_number',)
    fields = ('name', 'ship', 'created_on', 'duration', 'start_date', 'end_date', 'bookable',  # noqa
              'slug', 'description', 'results_image', 'listing_image', 'map_image', 'tags',)  # noqa
    readonly_fields = fields
...
class Bookings(admin.ModelAdmin):
    list_display = ('booking_ref', 'booked_by',
                    'booking_price', 'booked_on', 'ticket')
    fields = ('booking_ref', 'booked_by',
              'booking_price', 'booked_on', 'ticket')
    readonly_fields = fields
